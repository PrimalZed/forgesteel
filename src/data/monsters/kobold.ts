	...
	monsters: [
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Support, 'minion'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 6,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
			stamina: 4,
			stability: 0,
			freeStrikeDamage: 1,
		...
		},
		{
			...
			encounterValue: 6,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(6),
			stamina: 4,
			stability: 0,
			freeStrikeDamage: 1,
			withCaptain: 'Speed +1',
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Artillery, 'band'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 3,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Controller, 'band'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 3,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Defender, 'band'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 9,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Support, 'band'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 3,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
			...
			features: [
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						spend: [
							// TODO: "2+" to spend 2 malice multiple times, as described
							{ value: 2, effect: 'One additional ally can shift for every 2 malice spent.' }
						]
					})
				}),
				FeatureLogic.feature.createAbilityFeature({
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Ambusher, 'band'),
			keywords: [ 'Humanoid', 'Kobold' ],
			encounterValue: 3,
			size: MonsterLogic.createSize(1, 'S'),
			speed: MonsterLogic.createSpeed(5),
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Brute, 'troop'),
			keywords: [ 'Animal', 'Kobold' ],
			encounterValue: 12,
			size: MonsterLogic.createSize(3),
			speed: MonsterLogic.createSpeed(7, 'burrow'),
			stamina: 80,
			stability: 0,
			freeStrikeDamage: 5,
		...
		},
		{
			...
			description: '',
			level: 1,
			role: MonsterLogic.createRole(MonsterRoleType.Hexer, 'troop'),
			keywords: [ 'Animal', 'Kobold' ],
			encounterValue: 12,
			size: MonsterLogic.createSize(2),
			speed: MonsterLogic.createSpeed(5),
			stamina: 40,
			stability: 2,
			freeStrikeDamage: 4,
			...
			features: [
				...
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						type: AbilityLogic.type.createTrigger('A creature moves or is force moved into the cube.', true),
						distance: [ AbilityLogic.distance.createSelf() ],
						target: 'Self',
			...
			features: [
				...
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						spend: [
							// TODO: "3+" to spend 3 malice multiple times, as described
							{ value: 3, effect: 'The centurion targets 1 additional enemy for every 3 malice spent.' }
						]
					})
				}),
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						name: 'Testudo!',
						type: AbilityLogic.type.createTrigger('A creature uses an ability aginst the centurion or an ally.'),
						distance: [ AbilityLogic.distance.create({ type: AbilityDistanceType.Burst, value: 5 }) ],
				...
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						distance: [ AbilityLogic.distance.create({ type: AbilityDistanceType.Line, value: 10, value2: 1, within: 1 }) ],
				...
				FeatureLogic.feature.createAbilityFeature({
					ability: AbilityLogic.createAbility({
						...
						type: AbilityLogic.type.createVillainAction(),
						keywords: [ AbilityKeyword.Area, AbilityKeyword.Weapon ],
						distance: [ AbilityLogic.distance.create({ type: AbilityDistanceType.Cube, value: 5, within: 10 }) ],
